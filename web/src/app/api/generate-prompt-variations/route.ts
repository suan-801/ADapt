...
각 변형은 핵심 오브젝트의 정체성은 유지하되, 배경·조명·스타일을 창의적으로 변주하세요.

[필수 제약조건]
1. 프롬프트 본문은 무조건 영문으로 작성
2. 1500x1500 (1:1 비율) 설정 키워드 포함
3. 특정 기업 로고나 정당, 실존 브랜드 명칭 절대 배제
4. 이미지 내에 어떠한 텍스트나 글자도 포함되지 않도록(no text, textless) 명시할 것
${characterConstraint}
...
{
  "prompts": [
    { "type": "타겟/스타일명 (반드시 한국어 2~6자)", "prompt": "영문 프롬프트" },
    { "type": "...", "prompt": "..." },
    { "type": "..." , "prompt": "..." }
  ]
}`
